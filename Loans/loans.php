...
<div id="confirm" class="confirm-modal" style="display: none;">
        ...
        <br>
        <br>
        <p>Are you sure that you want to delete this loan?</p>
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class='btn btn-danger btn-sm delete-btn' data-url='/testephp/Loans/deleteLoans.php?id=$row[id]'>Delete</button>
                                </td>
                        </tr>
                        ";
                    }
