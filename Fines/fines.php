...
<body>
    <div id="confirm" class="confirm-modal" style="display: none;">
        ...
        <br>
        <br>
        <p>Are you sure that you want to delete this fine?</p>
            ...
            <tbody>
                <?php 
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <td>
                            <button class='btn btn-danger btn-sm delete-btn' data-url='/testephp/Fines/deleteFines.php?id=$row[id]'>Delete</button>
                        </td>
                    </tr>
                        ";
                    }
